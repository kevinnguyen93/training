...
class appTestProjectContainer extends Container
{
    ...
    {
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'training', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), new \Doctrine\DBAL\Configuration(), new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        $a = new \Doctrine\Common\Cache\ArrayCache();
        $a->setNamespace('sf2orm_default_90fc350240589872e33e0c1f11d36ce8fb87b6841cedb49263445d791811f333');
        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_90fc350240589872e33e0c1f11d36ce8fb87b6841cedb49263445d791811f333');
        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_90fc350240589872e33e0c1f11d36ce8fb87b6841cedb49263445d791811f333');
        ...
        $e->setProxyDir('D:/xampp/htdocs/training/trunk/mrhuy/app/cache/test/doctrine/orm/Proxies');
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('D:/xampp/htdocs/training/trunk/mrhuy/app/logs/test.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:D:/xampp/htdocs/training/trunk/mrhuy/app/cache/test/profiler', '', '', 86400), $a);
        $instance->disable();
        $instance->add($c);
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('D:/xampp/htdocs/training/trunk/mrhuy/app/cache/test/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('D:/xampp/htdocs/training/trunk/mrhuy/app/cache/test/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'D:/xampp/htdocs/training/trunk/mrhuy/app/../web', false);
        $instance->addWorker(new \Symfony\Bundle\AsseticBundle\Factory\Worker\UseControllerWorker());
        return $instance;
    }
    protected function getAssetic_CacheService()
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('D:/xampp/htdocs/training/trunk/mrhuy/app/cache/test/assetic/assets');
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'D:/xampp/htdocs/training/trunk/mrhuy/app/cache/test');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => false,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'D:/xampp/htdocs/training/trunk/mrhuy/app/cache/test',
            ...
            'session.save_path' => 'D:/xampp/htdocs/training/trunk/mrhuy/app/cache/test/sessions',
            ...
            'profiler.storage.dsn' => 'file:D:/xampp/htdocs/training/trunk/mrhuy/app/cache/test/profiler',
            ...
            'router.resource' => 'D:/xampp/htdocs/training/trunk/mrhuy/app/cache/test/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'D:/xampp/htdocs/training/trunk/mrhuy/app/cache/test/twig',
                'charset' => 'UTF-8',
                'paths' => array(
                ),
            ),
            ...
            'swiftmailer.spool.default.memory.path' => 'D:/xampp/htdocs/training/trunk/mrhuy/app/cache/test/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => 'D:/xampp/htdocs/training/trunk/mrhuy/app/cache/test/assetic',
            ...
            'doctrine.orm.proxy_dir' => 'D:/xampp/htdocs/training/trunk/mrhuy/app/cache/test/doctrine/orm/Proxies',
